...
import com.example.moham.webrtc.services.gcm.GooglePlayServicesHelper;
import com.example.moham.webrtc.ui.activity.CoreBaseActivity;
import com.example.moham.webrtc.util.QBResRequestExecutor;
import com.example.moham.webrtc.utils.Consts;
import com.example.moham.webrtc.utils.ErrorUtils;
    ...
    protected void showErrorSnackbar(@StringRes int resId, Exception e,
        ...
        if (getSnackbarAnchorView() != null) {
            ErrorUtils.showSnackbar(getSnackbarAnchorView(), resId, e,
                    com.example.moham.webrtc.R.string.dlg_retry, clickListener);
        }
    }
